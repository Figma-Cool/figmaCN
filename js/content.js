const allData = [
  ...
  [`export`, `导出`],
  [`Export`, `导出`],
  [`Expose nested instances, set preferred values for instance swaps, and simplify all instances.`, `展示嵌套实例，为实例切换设置首选值，并简化所有实例。`],
  [`Exposure`, `曝光`],
  ...
  [`Try Figma for free`, `免费体验 Figma`],
  [`Try it out`, `试试看`],
  [`Try new component property authoring features`, `试试新的组件属性创作功能。`],
  [`Try now`, `立即重试`],
