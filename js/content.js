const allData = [
  ...
  [`Public`, `公开`],
  [`Publish a version of this file to the Community for the public to duplicate and remix.`, `向社区发布该文件的一个版本，供公众复制和重新演绎。`],
  [`Publish File`, `发布文件`],
  ...
  [`Resources`, `资源`],
  [`Restart (R)`, `重新开始（R）`],
  [`Restore Default Thumbnail`, `恢复默认封面图`],
  ...
  [`This is your team's workspace. Create projects to help organize your files and invite members to your team to start collaborating. Click here to edit this description.`, `这是你的团队工作空间。创建项目来帮助组织你的文件，并邀请成员到你的团队来开始协作。点击这里来编辑这个介绍。`],
