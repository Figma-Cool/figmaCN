const allData = [
  ...
  [`About unsaved changes`, `关于未保存的更改`],
  [`About us`, `关于我们`],
  [`Accept`, `接受`],
  ...
  [`Figma saves pending changes in your browser, even while offline. When you’re back online, Figma will apply these changes to your file, even if you closed the tab.`, `即使在离线状态下，Figma 也可以将未完成的更改保存在浏览器中。当你重新上线时，Figma 会将这些更改应用于你的文件，即使你关闭你的标签页。`],
  ...
  [`You can use version history to review the changes.`, `你可以使用版本历史记录来查看更改。`],
