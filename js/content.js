const allData = [
  ...
  [`Your team is at its 3 design file limit. Upgrade for unlimited design files, projects, and fully customizable team libraries.`, `你的团队已达到 3 个设计文件的限制。升级无限的设计文件、项目和完全可定制的团队库。`],
