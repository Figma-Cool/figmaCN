const allData = [
  ...
  [`9 hours ago`, `9 小时前`],
  [`9 months ago`, `9 个月前`],
  [`A bi-weekly email of noteworthy files, plugins, widgets and creators`, `每两周一次的电子邮件，包括值得注意的文件、插件、小部件和创作者`],
  ...
  [`A weekly summary of Community engagement with my profile, files, plugins, and widgets`, `每周一次的总结，包括社区对我的个人资料、文件、插件和小工具的参与情况`],
  ...
  [`Comments left on my files, plugins, and widgets`, `对我的文件、插件和小部件留下的评论`],
  ...
  [`Go to the browser to complete login`, `转到浏览器以完成登录`],
  [`Gold`, `金色`],
  [`Got it`, `好的`],
