const allData = [
  ...
  [`Zoom`, `缩放`],
   // 以下为部分插件汉化翻译============================================
  [`SkewDat`, `SkewDat斜切`],
  [`SmoothShadow`, `SmoothShadow平滑阴影`],
  [`Arrow Auto`, `Arrow Auto 自动箭头`],
  [`Autoflow`, `Autoflow 自动流程`],
  [`EasyMask`, `EasyMask 简单遮罩`],
  [`Filter`, `Filter 滤镜`],
  [`Presets`, `预设`],
  [`Local Presets`, `本地预设`],
  [`Global Presets`, `全局预设`],
  [`Drag Presets here to access them in other Figma files.`, `将预设拖到这里，可以在其他Figma文件中访问它们。`],
  [`Default Preset 1`, `默认预设 1`],
  [`Brightness Contrast`, `亮度 对比度`],
  [`Hue Saturation`, `亮度 对比度`],
  [`Curves`, `曲线`],
  [`Exposure`,` 曝光`],
  [`Sepia`, `褐色`],
  [`Denoise`, `降噪`],
  ...
  [`Cartoon`, `卡通`],
  [`Unsharp Mask`, `USM 锐化`],
  [`Confetti`, `Confetti 彩屑`],
  [`Get Waves`, `Get Waves 波浪线`],
  [`Hero Patterns for Figma`, `Hero Patterns for Figma 填充图形`],
  [`Please select at least one layer.`, `请选择一个页面`],
  [`LottieFiles`, `Lottie动画`],
  [`Palette`, `Palette调色盘`],
  [`Pixel Perfect`, `Pixel Perfect 完美像素`],
  [`Wireframe`, `Wireframe 线框组件`],
  [`oblique`, `oblique 斜面`],
  [`Font Replacer`, `字体替换`],
  [`Please select one or more text layers to run Font Replacer.`, `请选择一个或多个文本层来运行字体替换器。`],
  [`Morph`, `Morph 变形`],
  [`Skeuo`, `体积`],
  [`Glitch`, `故障`],
  [`Neon`, `霓虹`],
  [`Reflect`, `镜面`],
  [`Glassy`, `毛玻璃`],
  [`Please select a shape or vector layer to apply any morph effects.`, `请选择一个形状或矢量层来应用变形效果。`],
]
