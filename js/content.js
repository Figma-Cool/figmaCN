const allData = [
  ...
  [`Borders`, `边框`],
  [`Bottom center alignment`, `底部居中对齐`],
  [`Bottom Center`, `底部居中`],
  [`Bottom left alignment`, `左下对齐`],
  [`Bottom left corner radius`, `左下圆角半径`],
  [`Bottom Left`, `左下`],
  [`Bottom padding`, `下边距`],
  [`Bottom right alignment`, `右下对齐`],
  [`Bottom right corner radius`, `右下圆角半径`],
  [`Bottom Right`, `右下`],
  [`Bottom`, `下`],
  [`Bouncy`, `跳动`],
  [`Brainstorming`, `头脑风暴`],
  ...
  [`Browse plugins in Community`, `浏览社区中的插件`],
  [`Browse plugins in Community →`, `浏览社区中的插件 →`],
  ...
  [`Changes saved`, `改动已保存`],
  [`Changes`, `改动`],
  [`Character variant 1`, `字符变形 1`],
  [`Character variant 10`, `字符变形 10`],
  [`Character variant 2`, `字符变形 2`],
  [`Character variant 3`, `字符变形 3`],
  [`Character variant 4`, `字符变形 4`],
  [`Character variant 5`, `字符变形 5`],
  [`Character variant 6`, `字符变形 6`],
  [`Character variant 7`, `字符变形 7`],
  [`Character variant 8`, `字符变形 8`],
  [`Character variant 9`, `字符变形 9`],
  ...
  [`Create component property`, `创建属性`],
  ...
  [`Edit instance swap property`, `选择组件实例`],
  ...
  [`Independent corners`, `单独设置圆角`],
  [`Independent paddings`, `单独设置边距`],
  [`Individual padding for more precise layouts`, `单独的边距使布局更精确`],
  [`Initial Forms`, `词首形式`],
  [`Inner border`, `内边框`],
  [`Inner shadow`, `内阴影`],
  ...
  [`Layout grids`, `布局网格`],
  [`Learn how to turn on closed captioning`, `了解如何开启和关闭字幕`],
  [`Learn more →`, `了解更多 →`],
  ...
  [`Set optical size automatically`, ` 自动适配视觉大小`],
  ...
  [`Stylistic set 1`, `字符格式 1`],
  [`Stylistic set 10`, `字符格式 10`],
  [`Stylistic set 11`, `字符格式 11`],
  [`Stylistic set 12`, `字符格式 12`],
  [`Stylistic set 13`, `字符格式 13`],
  [`Stylistic set 14`, `字符格式 14`],
  [`Stylistic set 15`, `字符格式 15`],
  [`Stylistic set 16`, `字符格式 16`],
  [`Stylistic set 17`, `字符格式 17`],
  [`Stylistic set 18`, `字符格式 18`],
  [`Stylistic set 19`, `字符格式 19`],
  [`Stylistic set 2`, `字符格式 2`],
  [`Stylistic set 20`, `字符格式 20`],
  [`Stylistic set 3`, `字符格式 3`],
  [`Stylistic set 4`, `字符格式 4`],
  [`Stylistic set 5`, `字符格式 5`],
  [`Stylistic set 6`, `字符格式 6`],
  [`Stylistic set 7`, `字符格式 7`],
  [`Stylistic set 8`, `字符格式 8`],
  [`Stylistic set 9`, `字符格式 9`],
  [`Stylistic sets 1`, `字符格式 1`],
  [`Stylistic sets`, `字符格式`],
  ...
  [`Apply instance swap property`, `使用交换组件实例属性`],
  ...
  [`Top & Bottom`, `上 & 下`],
  [`Top and bottom`, `上下拉伸`],
  [`Top center alignment`, `顶部居中对齐`],
  [`Top Center`, `顶部居中`],
  [`Top left alignment`, `左上对齐`],
  [`Top left corner radius`, `左上圆角半径`],
  [`Top Left`, `左上`],
  [`Top padding`, `上边距`],
  [`Top plugins`, `热门插件`],
  [`Top right alignment`, `右上对齐`],
  [`Top right corner radius`, `右上圆角半径`],
  [`Top Right`, `右上`],
  [`Top, right, bottom, and left padding can now be set independently.`, `现在可以单独设置四周的边距。`],
  [`Top`, `上`],
  [`Touch down`, `触摸按下`],
  [`Touch up`, `触摸离开`],
  ...
  [`Update all`, `全部更新`],
  [`Update`, `更新`],
  [`Update the curent page from`, `更新当前页面，来自`],
