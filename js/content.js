const allData = [
  ...
  [`✓  Org-wide team libraries`, `✓  全组织的团队资源库`],
  ...
  [`Create teams to share design libraries with collaborators and organize files into projects`, `创建团队，与合作者共享设计资源库，并将文件组织成项目。`],
  [`Created by `, `创建自 `],
  [`Created`, `创建时间`],
  ...
  [`Ellipse`, `椭圆`],
  [`Email`, `邮箱`],
  [`Enable and set default team libraries for all team files`, `启用并设置所有团队文件的默认团队资源库。`],
  ...
  [`Enable`, `启用`],
  [`Enabling a team library will make it show up in all team files.`, `启用团队资源库将使其显示在所有团队文件中。`],
  ...
  [`Publish update...`, `发布更新…`],
  [`Publish your changes to your team library.`, `将你的更改发布到你的团队资源库中。`],
  [`Publish...`, `发布…`],
  [`Publish`, `发布`],
  ...
  [`Shape`, `形状`],
  [`Share `, `分享 `],
  [`Share components and styles across your team by publishing them to the team library.`, `通过将组件和样式发布到团队资源库中，可以在你的团队中共享它们。`],
  ...
  [`Successfully published library updates`, `成功发布资源库更新`],
  [`Suffix`, `后缀`],
  [`Superscript`, `上标`],
  [`Support:`, `技术支持：`],
  [`Support`, `支持`],
  ...
  [`Upgrade to the Professional plan or to an Organization and get access to shared team libraries, advanced security features and`, `升级到专业版计划或组织版，可以使用共享的团队资源库、高级安全功能以及`],
