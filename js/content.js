const allData = [
	  ...
	  [`Hover`, `悬停`],
	  [`How to use this component`, `如何使用这个组件`],
	  [`Hue`, `色相`],
	  [`Hug contents`, `适应内容`],
	  [`Hug`, `适应`],
	  [`Icons`, `图标`],
	  ...
	  [`Letter spacing`, `字距`],
	  [`Letterforms`, `字母形式`],
	  [`Libraries used in this file`, `当前文件中使用的组件库`],
	  [`Libraries`, `组件库`],
	  [`Library`, `组件库`],
	  [`License`, `授权`],
	  [`Licensed under `, `授权协议：`],
	  ...
	  [`Stylistic alternates`, `文体替代字形`],
	  [`Stylistic set 1`, `文本格式 1`],
	  [`Stylistic set 10`, `文本格式 10`],
	  [`Stylistic set 11`, `文本格式 11`],
	  [`Stylistic set 12`, `文本格式 12`],
	  [`Stylistic set 13`, `文本格式 13`],
	  [`Stylistic set 14`, `文本格式 14`],
	  [`Stylistic set 15`, `文本格式 15`],
	  [`Stylistic set 16`, `文本格式 16`],
	  [`Stylistic set 17`, `文本格式 17`],
	  [`Stylistic set 18`, `文本格式 18`],
	  [`Stylistic set 19`, `文本格式 19`],
	  [`Stylistic set 2`, `文本格式 2`],
	  [`Stylistic set 20`, `文本格式 20`],
	  [`Stylistic set 3`, `文本格式 3`],
	  [`Stylistic set 4`, `文本格式 4`],
	  [`Stylistic set 5`, `文本格式 5`],
	  [`Stylistic set 6`, `文本格式 6`],
	  [`Stylistic set 7`, `文本格式 7`],
	  [`Stylistic set 8`, `文本格式 8`],
	  [`Stylistic set 9`, `文本格式 9`],
	  [`Stylistic sets 1`, `文本格式 1`],
	  [`Stylistic sets`, `文本格式`],
	  ...
	  [`Want to edit this file with others?`, `想与他人一起编辑此文件吗？`],
	  [`Want to edit this file?`, `想编辑此文件吗？`],
	  [`Watch`, `手表`],
