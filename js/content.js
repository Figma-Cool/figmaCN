const allData = [
  ...
  [`team settings`, `团队设置`],
  [`Team Templates`, `团队模板`],
  [`Team-level permissions: Admin`, `团队级权限：管理员`],
  [`Team-level permissions: All`, `团队级权限：全部`],
  [`Team-level permissions: Can edit`, `团队级权限：可以编辑`],
  [`Team-level permissions: Can view`, `团队级权限：可以查看`],
  [`Team-level permissions: No team permissions`, `团队级权限：没有团队级权限`],
  [`Team-level permissions: Owner`, `团队级权限：创建者`],
  [`Team-level permissions`, `团队级权限`],
  [`Teams`, `团队`],
  [`Temperature`, `白平衡`],
  [`Templates`, `模板`],
